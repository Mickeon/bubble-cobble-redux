...
ClientEvents.lang("en_us", event => {
	...
	event.add("item.minecraft.potion.effect.begone", "Potion of Begone",)
	event.add("item.minecraft.splash_potion.effect.begone", "Splash Potion of Begone",)
	event.add("item.minecraft.lingering_potion.effect.begone", "Lingering Potion of Begone",)
