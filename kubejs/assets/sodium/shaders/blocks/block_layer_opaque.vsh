#version 330 core
// Taken straight from https://modrinth.com/resourcepack/restored-brightness/gallery.
...
void main() {
    ...
    vec2 clamped_light_coord = clamp(_vert_tex_light_coord + 0.5 / 16.0, vec2(0.5 / 16.0), vec2(15.5 / 16.0));
    v_Color = _vert_color * texture(u_LightTex, clamped_light_coord);
