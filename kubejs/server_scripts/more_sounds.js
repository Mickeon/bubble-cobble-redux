...
ServerEvents.tags("item", event => {
	...
	event.add("bubble_cobble:sounds/grass_crunchy",
		/.*banner_pattern/, // Better than nothing...
		...
		"minecraft:feather", // Better than nothing...
		"minecraft:firework_star",
		"minecraft:glow_ink_sac", // Better than nothing...
		"minecraft:ink_sac", // Better than nothing...
		"minecraft:phantom_membrane", // Better than nothing...
		"minecraft:string", // Better than nothing...
		"minecraft:sugar",
		...
		"undergroundworlds:jungle_spores",
	)
	event.add("bubble_cobble:sounds/glass_frozen",
		...
		"undergroundworlds:freezing_hoe",
		"undergroundworlds:freezing_pickaxe",
		"undergroundworlds:freezing_shovel",
		"undergroundworlds:freezing_sword",
		"undergroundworlds:frozen_core",
	)
	event.add("bubble_cobble:sounds/glass_hollow",
